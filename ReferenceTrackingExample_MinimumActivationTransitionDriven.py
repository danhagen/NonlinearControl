...
PCSA1 = unit_conversion(
	return_primary_source(AllMuscleSettings["BIC"]["PCSA"]))
PCSA2 = unit_conversion(
	return_primary_source(AllMuscleSettings["TRI"]["PCSA"]))

F_MAX1 = unit_conversion(
	return_primary_source(AllMuscleSettings["BIC"]["Maximum Isometric Force"]))
F_MAX2 = unit_conversion(
	return_primary_source(AllMuscleSettings["TRI"]["Maximum Isometric Force"]))
...
TotalX,TotalU = run_N_sim_MAT(NumberOfTrials=25)
