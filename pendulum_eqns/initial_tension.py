...
def return_initial_tension(X_o,**kwargs):
	...
	**kwargs
	...
	InitialAngularAcceleration = kwargs.get("InitialAngularAcceleration",d2r(0)) # or d2r(0)
	assert type(InitialAngularAcceleration) in [float,int,np.float64], "InitialAngularAcceleration must be either a float or an int."
